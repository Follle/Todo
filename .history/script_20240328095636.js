...
function render() {// выводит инфу
    ...
    tasksList.innerHTML += `<div id="${item.id}" class="partic-task">
    ...
    checkAllCount = tasksArray.every((task) => task.isChecked === true);
...
function tasksCounter() {
    ...
    counter.innerHTML = '<label>Completed tasks: ${completedCount}</label><br><label>Uncompleted tasks: ${uncompletedCount}</label><br><label>All tasks: ${tasksArray.length}</label><br>';}
