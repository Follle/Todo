...
const showStatus = document.querySelector('.tab-btns');
...
// Добавляем обработчик события нажатия кнопки для каждой кнопки
showStatus.forEach(showStatus => showStatus.addEventListener("click", changeText));
