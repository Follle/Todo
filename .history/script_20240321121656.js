...
function render() {
    tasksList.innerHTML= "";
    tasksArray.forEach((elem) => tasksList.innerHTML += `<div id="${elem.id}" style="position: relative; width: 100px">
    <input type="checkbox" ${elem.isChecked ? 'checked' : '' } style="position: absolute">${elem.text}</input>
