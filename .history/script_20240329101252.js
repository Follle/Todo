...
function filterArray() {
    ...
    function render() {// выводит инфу
        ...
        // if (elem.text==""){console.log()}
        tasksList.innerHTML= "";
        info.slicedArr.forEach((elem) => if (elem.text=="")console.log();tasksList.innerHTML += `<div id="${elem.id}">
        <input type="checkbox" ${elem.isChecked ? 'checked' : ''}><label>${elem.text} (required)</label> 
        <button>X</button> `);
