...
function getPage(){
    ...
    for (let i = 0; i < pages; i++) {
        ...
        let page = tasksArray.slice(start, end);
        if ((tasksArray.length % 5 )=== 0) {
      ...
      function displayList(tasksArray, rowPerPage, page ){
    ...
    function displayPagination(){
        ...
        const pagesCount = Math.ceil(tasksArray.length / rowPerPage);
    ...
    displayList(tasksArray, rows, currentPage);
    displayPagination(tasksArray, rows)
